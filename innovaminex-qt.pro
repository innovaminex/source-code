...
macx:TARGET = innovaminex-qt
VERSION = 1.0.0.2
QMAKE_TARGET_BUNDLE_PREFIX = co.innovaminex
...
SOURCES += src/qt/bitcoin.cpp src/qt/bitcoingui.cpp \
    src/obj/raziel/skein.c \
    src/obj/raziel/cubehash.c \
    src/obj/raziel/gost.c \
    src/obj/raziel/fugue.c \
...
macx: {
    ...
    ICON = src/qt/res/icons/innovaminex.icns
