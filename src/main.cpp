...
#if defined(NDEBUG)
# error "innovaminex cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "innovaminex Signed Message:\n";
...
{   
    ...
    if (pindexBest->nHeight < 300){
        nSubsidy = 1000000 * COIN; //Use first 300 blocks to split up Pre-mine, helps with staking later on
...
#ifdef ENABLE_WALLET
// innovaminex: attempt to generate suitable proof-of-stake
...
{
    RenameThread("innovaminex-loadblk");
