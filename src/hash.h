...
#include "obj/raziel/sph_skein.h"
#include "obj/raziel/sph_cubehash.h"
#include "obj/raziel/sph_fugue.h"
#include "obj/raziel/sph_gost.h"
...
inline uint256 raziel(const T1 pbegin, const T1 pend)
