...
#ifdef Q_OS_MAC
    resize(960, 595);
    setWindowTitle(tr("InnovaMinex - MacOS wallet"));
#elif _WIN32
    resize(900, 580);
    setWindowTitle(tr("InnovaMinex - Windows wallet"));
#else
    resize(1000, 630);
    setWindowTitle(tr("InnovaMinex - Linux wallet"));
#endif
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a innovaminex address"));
    ...
    aboutAction = new QAction(tr("&About innovaminex"), this);
    aboutAction->setToolTip(tr("Show information about innovaminex"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for innovaminex"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("innovaminex client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("innovaminex client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to innovaminex network", "", count));
}
...
{
    QString strTitle = tr("innovaminex") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid innovaminex address or malformed URI parameters."));
    }
